...
class RevenueFormScreen extends StatefulWidget {
  const RevenueFormScreen({super.key});
...
class _RevenueFormScreenState extends State<RevenueFormScreen> {
  ...
  // Lista de categorias de exemplo (diferente de despesa)
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: Theme.of(
                  context,
                ).colorScheme.primary, // Cor principal (azul) para receita
              ),
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: Theme.of(
                  context,
                ).colorScheme.primary, // Cor de destaque para receita
